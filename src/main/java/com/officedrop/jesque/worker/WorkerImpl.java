...
import com.officedrop.jesque.utils.DaemonThreadFactory;
import com.officedrop.jesque.utils.JesqueUtils;
import com.officedrop.jesque.utils.ReflectionUtils;
import com.officedrop.jesque.utils.VersionUtils;
...
public class WorkerImpl extends BaseWorker implements Worker {
	...
	protected void register() {
		...
		this.jedisPool.withJedis(new JedisFunction() {
	...
	private String pop(final String queue) {
		...
		return this.jedisPool.withJedis(new JedisResultFunction<String>() {

			@Override
			public String execute(JedisActions jedis) {
	...
	public Collection<String> getQueuesFromJedis() {
		...
		return this.jedisPool
				.withJedis(new JedisResultFunction<Collection<String>>() {

					@Override
					public Collection<String> execute(JedisActions jedis) {
